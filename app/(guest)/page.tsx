...
export default function Home() {
  ...
  return (
    <Curtain onOpen={startExperience}>
      ...
      */}
      <main className="h-[100dvh] w-full overflow-y-scroll snap-y snap-mandatory bg-stone-900 selection:bg-stone-200 overflow-x-hidden">
...
<footer className="h-[100dvh] w-full flex flex-col items-center justify-center bg-white snap-start px-4 mb-0 pb-0">
  <ScrollReveal>
